...
# Add this directory to sys.path so siblings are importable when run directly
...
if __name__ == '__main__':
    ...
    # Default model path: look in a 'models' folder in the project root
    ...
    if not Path(model_path).exists():
        ...
        print(f'  python pipeline.py {image_path} {output_dir} /path/to/model.pt')
        sys.exit(1)
